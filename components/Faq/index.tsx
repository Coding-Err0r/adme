              ...
              <Slideup
                ...
                component={
                  <div className="w-full bg-white shadow-xl lg:h-full rounded-2xl">
                    <div className="flex flex-col items-center justify-center w-full h-full pb-6 space-y-5">
                      <div className="flex justify-center pt-10">
                        <Image
                          ...
                          width={2000}
                          height={2000}
                          className="relative z-0 object-cover w-16 h-16 rounded-full"
                        />
                        <Image
                          ...
                          width={2000}
                          height={2000}
                          className="absolute z-10 object-cover w-16 h-16 mx-12 -mt-3 border-2 border-white rounded-full"
                        />
                        <Image
                          ...
                          width={2000}
                          height={2000}
                          className="relative z-0 object-cover w-16 h-16 ml-5 rounded-full"
                        />
                      </div>
                      ...
                      <button className="relative z-10 px-10 py-4 text-lg font-semibold text-white md:text-xl bg-violet-500 rounded-2xl hover:bg-violet-800">
                        Get in touch
                      </button>
                    </div>
                  </div>
