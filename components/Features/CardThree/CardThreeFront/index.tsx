...
const CardThreeFront = () => {
  return (
    <div className=" xl:w-[23rem] xl:h-[27rem] md:h-[25.3rem] md:w-[20.3rem] bg-gradient-to-t from-sky-400 via-blue-500 to-blue-600 md:rounded-[20px] overflow-hidden p-8 flex items-center justify-center font-poppins w-[19.5rem] h-[11rem] rounded-2xl relative">
