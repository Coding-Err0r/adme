...
const CardFourBack = () => {
  return (
    <div className="xl:w-full xl:h-[27rem] md:h-[25.3125rem] md:w-[43.125rem] bg-white md:rounded-[40px] overflow-hidden p-8 flex items-center justify-center font-poppins w-full h-[10rem] rounded-3xl">
