...
const CardTwoBack = () => {
  return (
    <div className="xl:w-[24rem] xl:h-[27rem] md:h-[25.3rem] md:w-[20.6rem] bg-[#323131] md:rounded-[40px] overflow-hidden p-6 flex items-center justify-center font-poppins w-full h-[10rem] rounded-3xl">
