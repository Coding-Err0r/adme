...
const CardTwoBack = () => {
  return (
    <div className="xl:w-[24rem] xl:h-[27rem] md:h-[25.3rem] md:w-[20.6rem] bg-[#323131] md:rounded-[20px] overflow-hidden p-6 flex items-center justify-center font-poppins w-[19.5rem] h-[11rem] rounded-2xl">
