        ...
        <div className=" w-[80%] max-w-7xl">
          ...
          <div className="flex flex-col items-start space-y-10">
            ...
            <p className="text-sm text-left text-gray-700 lg:text-xl md:text-lg ">
              ...
              Systems, Inc., (“Mobilo”, “we”, “us”, or “our”). We are committed
              ...
              contact us at hello@mobilocard.com. This Privacy Policy applies to
              all information collected through our website (at
              https://www.mobilocard.
            </p>
            <p className="text-sm text-left text-gray-900 lg:text-xl md:text-lg ">
            ...
            <div className="flex flex-col space-y-8">
              ...
              <p className="text-sm text-left text-gray-700 lg:text-xl md:text-lg ">
                ...
                such as name, address, contact information, and other
                information you voluntarily provide us. We collect personal
                information that you voluntarily provide to us (i) when you sign
                up for the Site or Services, (ii) when you express an interest
                in obtaining information about us or our products and services,
                (iii) automatically as you use the Site or Services, or (iv)
                otherwise when contacting us.
              </p>
            </div>
            <div className="flex flex-col space-y-8">
              <p className="text-sm font-bold text-left text-gray-800 lg:text-4xl md:text-lg ">
              ...
              <ul className="text-sm text-left text-gray-700 list-disc lg:text-xl md:text-lg">
                ...
                <li className="px-4 ml-6">
                  Device Data. We, or our service providers, collect information
                  about your device such as unique device identifier, media
                  access control address, network information, hardware model,
                  browser type, screen resolution, IP address, as well as usage
                  and traffic data and information about how the device
                  interacts with the Site or Services.
                </li>
              </ul>
            </div>
          </div>
